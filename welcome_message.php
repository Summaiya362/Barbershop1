...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-no-bg" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= base_url('about') ?>">Barbershop</a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        ...
                        <span class="li-social">
                            <a href="<?= base_url('about') ?>"><i class="fa fa-facebook"></i></a>
                            <a href="<?= base_url('about') ?>"><i class="fa fa-twitter"></i></a>
                            <a href="<?= base_url('about') ?>"><i class="fa fa-instagram"></i></a>
                            <a href="<?= base_url('about') ?>"><i class="fa fa-youtube"></i></a>
                        </span>
                    </li>
                </ul>
            </div>
        ...
        <div class="inner-bg">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-5 form-box inner-bg">
                        <div class="form-top">
                        ...
                        <div class="form-bottom">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="form-name" placeholder="Nama Lengkap Anda..."
                                    class="form-name form-control" id="form-name" maxlength="50" required>
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-date">Tanggal</label>
                                <input type="text" name="form-date" placeholder="Pilih Tanggal..."
                                    class="form-time form-control" id="form-date" required>
                            </div>
                            <div class="form-group">
    ...
    $.backstretch([
        ...
        "assets/img/backgrounds/cpy.jpg",
...
<div class="text-visible-lg-block">Copyright &copy; UBSI CENGKARENG
    <?php echo date("Y"); ?></div>
