    ...
    <div id="top-nav" class="navbar navbar-inverse navbar-static-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>administrator">UBSI Cengkareng | Barbershop</a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="<?php echo base_url(); ?>administrator/logout"><i class="glyphicon glyphicon-lock"></i>
                            Logout</a></li>
                </ul>
            </div>
        </div>
